...
export class CreateFirstTable1612197057988 implements MigrationInterface {
    name = 'CreateFirstTable1612197057988';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            "CREATE TABLE `user_sms_validators` (`id` varchar(36) NOT NULL, `code` varchar(255) NOT NULL COMMENT '验证码', `type` enum ('registration', 'reset-password') NOT NULL COMMENT '验证码类型', `created_at` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `phone` varchar(255) NOT NULL COMMENT '手机号', PRIMARY KEY (`id`)) ENGINE=InnoDB",
        );
        await queryRunner.query(
            "CREATE TABLE `content_comments` (`id` varchar(36) NOT NULL, `body` longtext NOT NULL COMMENT '评论内容', `createdAt` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), `nsleft` int NOT NULL DEFAULT '1', `nsright` int NOT NULL DEFAULT '2', `parentId` varchar(36) NULL, `postId` varchar(36) NULL, `creatorId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB",
        );
        await queryRunner.query(
            "CREATE TABLE `content_posts` (`id` varchar(36) NOT NULL, `title` varchar(255) NOT NULL COMMENT '文章标题', `body` longtext NOT NULL COMMENT '文章内容', `summary` varchar(255) NULL COMMENT '文章描述', `keywords` text NULL COMMENT '关键字', `isPublished` tinyint NOT NULL COMMENT '是否发布' DEFAULT 0, `publishedAt` varchar(255) NULL COMMENT '发布时间', `createdAt` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `authorId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB",
        );
        await queryRunner.query(
            "CREATE TABLE `content_categories` (`id` varchar(36) NOT NULL, `name` varchar(255) NOT NULL COMMENT '分类名称', `slug` varchar(255) NOT NULL COMMENT '分类标识符', `order` int NOT NULL COMMENT '分类排序' DEFAULT '0', `nsleft` int NOT NULL DEFAULT '1', `nsright` int NOT NULL DEFAULT '2', `parentId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB",
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('DROP TABLE `user_sms_validators`');
