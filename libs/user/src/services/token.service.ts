import { Configure, time } from '@gkr/core';
...
import { AccessTokenEntity, RefreshTokenEntity, UserEntity } from '../database/entities';
...
export class TokenService {
    ...
    async generateAccessToken(user: UserEntity, now: dayjs.Dayjs) {
        ...
        const refreshToken = await this.generateRefreshToken(accessToken, time());
    ...
    async checkAccessToken(value: string) {
        return await AccessTokenEntity.findOne({
            where: { value },
